...
const _Grakn_methods = MethodDescriptor[
        ...
        MethodDescriptor("transaction", 8, Channel{grakn.protocol.Transaction_Client}, Channel{grakn.protocol.Transaction_Server})
...
transaction(stub::GraknStub, controller::ProtoRpcController, inp::Channel{grakn.protocol.Transaction_Client}, done::Function) = call_method(stub.impl, _Grakn_methods[8], controller, inp, done)
transaction(stub::GraknBlockingStub, controller::ProtoRpcController, inp::Channel{grakn.protocol.Transaction_Client}) = call_method(stub.impl, _Grakn_methods[8], controller, inp)
