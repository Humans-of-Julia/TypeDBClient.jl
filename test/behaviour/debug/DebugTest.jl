...
# 
# package typedb.client.test.behaviour.debug;
# 
...
#     // 1) Use '//<this>/<package>/<name>:test-core' to test against typedb-core
#     // 2) Use '//<this>/<package>/<name>:test-kgms' to test against typedb-kgms
#     //
